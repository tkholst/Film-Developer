...
//const short up = 2, down = 3, enter = 5, back = 4; //for 4-button pad marked 1 2 3 4
const short up = 3, down = 2, enter = 4, back = 5; //for 4-button pad unmarked
String fileName[20];
short runTemp;
float temperature = 0;
...
//        TFTscreen.print("  ");
  ...
  TFTscreen.rect(0, 0, TFTscreen.width(), TFTscreen.height());
  TFTscreen.setTextSize(2);
  TFTscreen.setCursor(16, 50);
  TFTscreen.println(" Reload!");
  wfe();
  //    }
}
